// tests/LlmProxy.Tests.Unit/Controllers/ChatControllerTests.cs
using System;
...
public class ChatControllerTests
{
    ...
    public ChatControllerTests()
    {
        ...
        // Инициализируем Response.Body для стриминга
    ...
    public async Task CreateChatCompletion_HandlesProviderError_WithFallback()
    {
        ...
        // Ожидаем, что контроллер перехватит исключение и вернет 502
        var result = await _controller.CreateChatCompletion(request);
